...
<br>
    ...
    <div class="book-appointment">
        ...
        <h1 style="color:white" ;>MODIFICACIONES COORDINADOR DE FACULTAD </h1>
        <br>
                    ...
                    <div class="row">
                        ...
                        <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
                            <b>Buscar por Nombre: </b><input type="text" id="campo" name="campo" /><button type="submit"
                                class="btn btn-dark" id="enviar" name="enviar"><i class="fas fa-search"></i>
                                Buscar</button>
                        </form>
                    </div>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="col-12 linkL"><a class="btn btn btn-dark"
                                            href="modCF.php?id_coordinador_facultad=<?php echo $row['id_coordinador_facultad'];?>"><i

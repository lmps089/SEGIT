<?php
  ...
  $where = "";
	...
	$sql = "SELECT id_coorTerapeuta,nombre,apellido_materno,apellido_paterno FROM coordinador_terapeuta $where";
...
<div class="book-appointment">
    ...
    <h1 style="color:white";>MODIFICACIONES COORDINADOR DE TERAPEUTA </h1>

        <div class="row">

          <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
            <b>Buscar por Nombre: </b><input type="text" id="campo" name="campo" /><button type="submit" class="btn btn-dark" id="enviar" name="enviar" ><i class="fas fa-search"></i> Buscar</button>
          </form>
        </div>
          ...
          <table class="table table-striped">
            ...
            <tbody>
              <?php while($row = $resultado->fetch_array(MYSQLI_ASSOC)) { ?>
                <tr>
                  <td><?php echo $row['id_coorTerapeuta']; ?></td>
                  <td><?php echo $row['nombre']; ?></td>
                  <td><?php echo $row['apellido_paterno']; ?></td>
                  <td><?php echo $row['apellido_materno']; ?></td>
                  <td><div class="col-12 linkL"><a class="btn btn btn-dark" href="modCT.php?id_coorTerapeuta=<?php echo $row['id_coorTerapeuta'];?>"> <i class="fas fa-edit"></i> Modificar</a></td></div>
                </tr>
   		...
   		<div class="book-appointment">
           <input type="submit" onclick="location.href='Modificaciones.php'" value="REGRESAR"  style="   margin-left: 10px  ">
      </div>

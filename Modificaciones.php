...
<body>
    ...
    <div class="bg-agile">
        ...
        <div class="book-appointment">
            ...
            <h1>SEGIT TUTORIA UAEMEX ADMINISTRADOR</h1>
          

                <div id="resultados_ajax" class="gaps"></div>
                <div class="left-agileits-w3layouts same">
  
                    <input type="submit" onclick="location.href= 'tablaModCF.php'"
                        value="Modificar Coordinador Facultad" style="margin-right: 30px">


                    <input type="submit" onclick="location.href= 'tablaModCT.php'"
                        value="Modificar Coordinador Terapeuta" style="margin-right: 30px">

                    <input type="submit" onclick="location.href= 'tablaModT.php'" value="Modificar Terapeuta"
                        style="margin-right: 30px">

                    <input type="submit" onclick="location.href= 'tablaModA.php'" value="Modificar Alumno"
                        style="margin-right: 30px">


                    <input type="submit" onclick="location.href= 'welcome.php'" value="SALIR"

...
<body>
    ...
    <div class="bg-agile">
        ...
        <div class="book-appointment">
            ...
            <h1>
                SEGIT TUTORIA UAEMEX ADMINISTRADOR
            </h1>
            ...
            <div class="left-agileits-w3layouts same">
                ...
                <input type="submit" onclick="location.href= 'altaUsuariosF.php'" value="Registrar Coordinador Facultad"
                    style="margin-right: 30px">


                <input type="submit" onclick="location.href= 'altaUsuariosT.php'"
                    value="Registrar Coordinador Terapeuta" style="margin-right: 30px">


                <input type="submit" onclick="location.href= 'ALTTerap.php'" value="Registrar Terapeuta"
                    style="margin-right: 30px">

                <input type="submit" onclick="location.href= 'ALTAluCoord.php'" value="Registrar Alumno"
                    style="margin-right: 30px">

<?php
  ...
  $consulta="SELECT diaSemanaT, horaT FROM horarioT WHERE id_terapeutaFK=$id_terapeuta";
  $resultadoCon=$mysqli->query($consulta);
  $fila=$resultadoCon->fetch_array(MYSQLI_ASSOC);
    ...
    <div class="book-appointment">
        ...
        <h1 style="color:white" ;> HORARIOS ALUMNO <h1>
                ...
                <div class="horarioTera">
                    <p>Aqui debe elegir sus horarios que tiene libre a la semana:</p>
                </div>
                <br>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
                                        <input type="checkbox" name="hora1L" <?php if( (strpos($fila['horaT'], "8 : 00 - 9 : 00")!== false) && (strpos($fila['diaSemanaT'], "Lunes")!== false) ){ echo 'checked';}    ?>/>
                                ...
                                <td>
                                    <!--martes-->
                                    <input type="checkbox" name="hora1M" <?php if( (strpos($fila['horaT'], "8 : 00 - 9 : 00")!== false) && (strpos($fila['diaSemanaT'], "Martes")!== false) ){ echo 'checked';}    ?> />
                                    <input type="hidden" name="horaMartes1" value="8 : 00 - 9 : 00">
                                    <input type="hidden" name="martesHora1" value="Martes">
                                </td>
                                <!--miercoles-->
                                <td>
                                    <input type="checkbox" name="hora1Mi" <?php if((strpos($fila['horaT'], "8 : 00 - 9 : 00")!== false) && (strpos($fila['diaSemanaT'], "Miercoles")!== false)){ echo 'checked';}  ?> />
                                    <input type="hidden" name="horaMiercoles1" value="8 : 00 - 9 : 00">
                                    <input type="hidden" name="miercolesHora1" value="Miercoles">
                                </td>
                                <td>
                                    <!--jueves-->
                                    <input type="checkbox" name="hora1J" <?php if((strpos($fila['horaT'], "8 : 00 - 9 : 00")!== false) && (strpos($fila['diaSemanaT'], "Jueves")!== false)){echo 'checked'; }  ?>/>
                                    <input type="hidden" name="horaJueves1" value="8 : 00 - 9 : 00">
                                    <input type="hidden" name="juevesHora1" value="Jueves">
                                </td>
                                <td>
                                    <!--viernes-->
                                    <input type="checkbox" name="hora1V" <?php if((strpos($fila['horaT'], "8 : 00 - 9 : 00")!== false) && (strpos($fila['diaSemanaT'], "Viernes")!== false)) echo 'checked'; ?> >
                            ...
                            <tr>
                                ...
                                <td>
                                    <!--lunes-->
                                    <input type="checkbox" name="hora2L" <?php if((strpos($fila['horaT'], "9 : 00 - 10 : 00")!== false) && (strpos($fila['diaSemanaT'], "Lunes")!== false)) echo 'checked'; ?> />
                                ...
                                <td>
                                    <!--martes-->
                                    <input type="checkbox" name="hora2M" <?php if((strpos($fila['horaT'], "9 : 00 - 10 : 00")!== false) && (strpos($fila['diaSemanaT'], "Martes")!== false)) echo 'checked'; ?> >

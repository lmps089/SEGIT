                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-2 offset-md-2">
                                        ...
                                        <a style="background:rgba(20, 90, 50, 0.68);" href="ELITeraCor.php" class="btn btn-success btn-lg active" role="button" aria-pressed="true"><i class="fas fa-arrow-alt-circle-left"></i> Regresar</a>
                                    </div>
                                </div>
                            </div>
                        </div>

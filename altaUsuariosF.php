...
if (!empty($_POST)) {
  ...
  if (count($errors) == 0) {
    ...
    if ($registroUsuario == true) {
      ...
      header("location: alta_coordinador_Factultad.php");
    } else {
...
<head>
  ...
  <title>Alta de usuarios de coordinadores de facultad</title>
  <meta charset="UTF-8">
...
<body>
  ...
  <div class="bg-agile">
    <div class="book-appointment">
      <h1> ALTA DE USUARIOS COORDINACION DE FACULTAD</h1>

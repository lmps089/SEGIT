...
<div class="book-appointment">
    ...
    <h1 style="color:white";> BAJAS COORDINADOR DE TERAPEUTA <h1>
            ...
            <tbody>
              <?php while($row = $resultado->fetch_array(MYSQLI_ASSOC)) { ?>
                <tr>
                  ...
                  <td><a class="btn btn-primary" href="#" data-toggle="modal" data-target="#confirm-delete" data-href="bajaCoorT.php?id_coorTerapeuta=<?php echo $row['id_coorTerapeuta'];?>"><i class="fas fa-trash-alt"></i></a></td>
                </tr>
              <?php } ?>
            </tbody>
          </table>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <p>¿Desea eliminar este registro?:</p> 
                <b>Para eliminar el coordinador, primero debe eliminar a los terapeutas a su cargo.</b>

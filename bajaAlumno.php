            ...
            <div class="col-md-2 offset-md-2">
                <div class="card" style="width: 600px;">
                    ...
                    <div class="text-center">
                        ...
                        <p style="font-size: 18px;" class="card-text">El alumno, cuenta con una terapea asignanda.</p>
                        <div class="container">
                            <div class="row">
                                <div class="col-md-2 offset-md-2">
                                   
                                        <a style="background:rgba(20, 90, 50, 0.68);" href="ELIAlumno.php" class="btn btn-success btn-lg active" role="button" aria-pressed="true"><i class="fas fa-arrow-alt-circle-left"></i> Regresar</a>
                                    </div>
                                </div>
                            </div>
                        </div>
